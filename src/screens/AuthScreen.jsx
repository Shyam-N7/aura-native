...
const styles = StyleSheet.create({
  ...
  formError: { fontFamily: fonts.regular, fontSize: 13, lineHeight: 18, marginBottom: 12 },
  submit: {
    alignItems: 'center',
    borderRadius: 12,
    marginTop: 4,
  ...
  strengthLabel: { fontFamily: fonts.regular, fontSize: 11 },
  ...
  deviceInfo: { flex: 1 },
  deviceLabel: { fontFamily: fonts.semibold, fontSize: 14, marginBottom: 2 },
  deviceMeta: { fontFamily: fonts.regular, fontSize: 12 },
  deviceRemove: {
    borderRadius: 10,
    borderWidth: 1,
  ...
  deviceRemoveText: { fontFamily: fonts.semibold, fontSize: 12 },
  dim: { opacity: 0.5 },
});
